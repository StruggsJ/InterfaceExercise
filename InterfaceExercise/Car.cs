...
namespace InterfaceExercise 
{
    public class Car : ICompany, IVehicle
    {
        ...
        public bool HasFunctionalTrunk { get; set; } = true;
        public bool HasSpareWheel { get; set; } = true;
        ...
        {
            Console.WriteLine($"Needs Trunk Repairs: {HasFunctionalTrunk}");
            Console.WriteLine($"Has a Spare Tire: {HasSpareWheel}");
        }
    }
}
